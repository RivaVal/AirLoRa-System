...
//=============================================================================
    ...
    constexpr uint8_t LORA_RST   = 11;    // 🔑 ИЗМЕНЕНО: 13→11 (устранён конфликт с MISO)
    constexpr uint8_t LORA_DIO0  = 4;     // Прерывание пакета (RxDone)
    constexpr uint8_t LORA_DIO1  = 14;    // Прерывание таймаута (RxTimeout)
    ...
    constexpr uint8_t FSPI_MISO  = 13;    // 🔑 ИЗМЕНЕНО: перенесён RST с 13 на 11
    constexpr uint8_t FSPI_MOSI  = 15;    // 🔑 ИЗМЕНЕНО: 11→15 (освобождаем 11 для RST)
